#!/usr/bin/env python3
"""Comprehensive ANE profiling for Qwen3.5-4B — Milestone 1.3 (tensor-value slice).
...
Usage:
    ...
    python tests/dev/qwen35_profile.py --tokens 40 --skip-cpu-compare
    python tests/dev/qwen35_profile.py --export-dir /path/to/models --quick
"""
import sys
...
def main():
    ...
    print("=" * 85)
    print("  ANE PROFILING — Qwen3.5-4B Milestone 1.3 (Tensor-Value Slice)")
    ...
    print(f"  KV Indexing: tensor-value slice — current_pos[0] (Milestone 1.3)")
