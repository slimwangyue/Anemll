#!/usr/bin/env python3
"""
V4 ALL CHUNKS — CTX=4096 Export + LUT4 Dedup

Exports all 9 chunks at CTX=4096 with V4 precision policy
...
Output: artifacts/v4_all_chunks_ctx4096/
"""
import argparse
import gc
import json
...
ARTIFACT_DIR = os.path.join(REPO_ROOT, "artifacts", "v4_all_chunks_ctx4096")
# Chunk 2 was already exported here:
CHUNK2_EXISTING = os.path.join(REPO_ROOT, "artifacts", "v4_chunk2_ctx4096")
