#!/usr/bin/env python3
"""Qwen3.5-4B Milestone 2.0: Multi-round conversation validation.
...
Usage:
    ...
    python scripts_qwen3_5/validate.py --model-dir /path/to/models \\
...
def main():
    ...
    parser.add_argument("--model-dir", type=str, default=DEFAULT_OUTPUT,
    ...
    print("=" * 80)
    print("  Qwen3.5-4B Multi-Round Validation — Milestone 2.0")
