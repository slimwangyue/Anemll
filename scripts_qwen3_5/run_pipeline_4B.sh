#!/usr/bin/env bash
# Qwen3.5-4B — V4+P2+D2 Production Pipeline (export → combine → compile → validate → vision)
#
...
echo ""
echo "======================================================================"
echo "  V4+P2+D2 + Vision Pipeline Complete! (Milestone 4)"
echo ""
...
echo "    $PYTHON scripts_qwen3_5/chat_server_vision.py \\"
echo "      --model-dir $OUTPUT \\"
echo "      --num-chunks $NUM_CHUNKS --ctx 4096 --port 8080"
echo ""
